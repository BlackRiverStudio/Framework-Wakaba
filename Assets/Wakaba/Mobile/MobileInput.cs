...
/// <summary>Module used to impliment mobile platform input and interactivity.</summary>
namespace Wakaba.Mobile
{
    /// <summary>Manages functionality for mobile compatability. To activate, simply use: MobileInput.Initialise();.</summary>
    public class MobileInput : MonoBehaviour
    {
        ...
        /// <summary>Get the diretion and power of the specific flick.</summary>
